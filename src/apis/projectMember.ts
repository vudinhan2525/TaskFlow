...
export const projectMembers = {
  add: (data: AddProjectMemberParams) =>
    api.post<IProjectMember>(
      `/projects/${data.project_id}/members`,
      data,
      config,
    ),
  addMembersToTeam: (data: AddProjectMemberToTeamParams) =>
    api.post<IProjectMember>(
      `/projects/${data.project_id}/teams/${data.team_id}/members`,
      data,
      config,
    ),
  ...
  list: (params: ListProjectMemberParams) => {
    let url = `/projects/${params.project_id}/members`;
  ...
  approve: (projectId: string, userId: string) =>
    api.put<ResponseApi<IProjectMember>>(
      `/projects/${projectId}/members/${userId}/approve`,
      {},
      config,
    ),

  reject: (projectId: string, userId: string) =>
    api.put<ResponseApi<void>>(
  ...
  acceptInvitation: (projectId: string) =>
    api.put<ResponseApi<IProjectMember>>(
      `/projects/${projectId}/invitations/accept`,
      {},
      config,
    ),
  ...
  rejectInvitation: (projectId: string) =>
    api.put<ResponseApi<void>>(
      `/projects/${projectId}/invitations/reject`,
      {},
      config,
    ),
};
